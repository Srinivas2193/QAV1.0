...
import Video from './../../../../src/assets/videos/Functionaltesting/cucumber.mp4'
...
<div className="flex flex-col bg-white  border-2 rounded-lg shadow-lg mt-[50px] md:flex-col md:max-w-xl">
  <img className="object-cover w-full rounded-t-lg h-96 md:rounded-none md:rounded-l-lg" src={cucumber} alt="sel" />
