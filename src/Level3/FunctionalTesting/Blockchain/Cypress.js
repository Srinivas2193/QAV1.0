...
//import Video from './../../../../src/assets/videos/Functionaltesting/cypress1.mp4'

import Video from './../../../assets/videos/Functionaltesting/cypress1.webm'
...
<div className="flex flex-col bg-white  border-2 rounded-lg shadow-lg mt-[50px] md:flex-col md:max-w-xl">
  <img className="object-cover w-full rounded-t-lg h-96 md:rounded-none md:rounded-l-lg" src={cypress} alt="sel" />
  <div className="flex flex-col justify-start p-6">
    ...
    <Link to="/home/functionl/blockchain/cypressReport"> <p className="text-[20px] hover:text-orange-400">View pdf</p> </Link>
  </div>
</div>
</div>
      </div>
