...
import Video from './../../../assets/videos/Securitytesting/Blockchain/WireShark.mp4'
...
<div className="flex flex-col bg-white  border-2 rounded-lg shadow-lg mt-[50px] md:flex-col md:max-w-xl">
  <img className="object-cover w-full rounded-t-lg h-[318px] md:rounded-none md:rounded-l-lg" src={wireshark} alt="sel" />
