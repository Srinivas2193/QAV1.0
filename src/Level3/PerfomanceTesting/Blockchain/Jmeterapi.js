...
import Video from './../../../assets/videos/PerfomanceTesting/Blockchain/jmeterapi.mp4'

//import exelform from './../../../assets/files/perfomancetesting/Blockchain/COYNI_V2_API_CUSTOMER_RT.csv'
...
<div className="flex flex-col bg-white  border-2 rounded-lg shadow-lg mt-[50px] md:flex-col md:max-w-xl">
  <img className="object-cover w-full rounded-t-lg h-[318px] md:rounded-none md:rounded-l-lg" src={jmeterapi} alt="sel" />
  <div className="flex flex-col justify-start p-6">
    ...
    <a className="text-[20px] hover:text-orange-400" href="https://ideyalabscom-my.sharepoint.com/:x:/r/personal/suryap_ideyalabs_com/_layouts/15/Doc.aspx?sourcedoc=%7B86DCD02E-37BE-4A4F-AADF-D615D682ABA8%7D&file=COYNI_V2_API_CUSTOMER_RT.csv&action=default&mobileredirect=true"  target="blank" alt="Jmeter Api" >View Report</a>
