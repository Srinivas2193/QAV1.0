...
import Video from './../../../assets/videos/PerfomanceTesting/Blockchain/loctus.mp4'
...
<div className="flex flex-col bg-white  border-2 rounded-lg shadow-lg mt-[50px] md:flex-col md:max-w-xl">
  <img className="object-cover w-full rounded-t-lg h-[318px] md:rounded-none md:rounded-l-lg" src={locust} alt="sel" />
  <div className="flex flex-col justify-start p-6">
    ...
    <Link to="/home/perfomsncetetsing/blockchain/locust/report"> <p className="text-[20px] hover:text-orange-400">View pdf</p> </Link>
  </div>
</div>
</div>
      </div>
