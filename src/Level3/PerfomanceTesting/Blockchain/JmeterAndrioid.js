...
<div className="flex flex-col bg-white  border-2 rounded-lg shadow-lg mt-[50px] md:flex-col md:max-w-xl">
  <img className="object-cover w-full rounded-t-lg h-[318px] md:rounded-none md:rounded-l-lg" src={jmeterAndroid} alt="sel" />
